...
<body>
    ...
    <form action="carrom_play_details.php" method="post">
    <p>Player 1 Name</p>
...
$sql="SELECT player_name FROM carrom_reg_s WHERE event_id='$existing_id'";
...
if ($result->num_rows > 0) 
    ...
    if ($result->num_rows > 0) 
        ...
        {
            $sql="INSERT INTO carrom_live (`player_1`, `player_2`) VALUES ('$name1','$name2')";
                 ...
                 if ($result->num_rows > 0) 
        {
            while($row = $result->fetch_assoc())
            {
                $_SESSION['car_id']=$row['car_id'];
                 ...
                 echo "<script> window.location.assign('carrom_s_match.php'); </script>";
            }
            else{
