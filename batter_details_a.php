...
<body>
    ...
    <form action="batter_details_a.php" method="post">
    <p>Striker Name</p>
...
// echo $team_name_b;
// echo $existing_id;
echo"<h1>Batting details for TEAM $team_name_a</h1>";
...
if ($result->num_rows > 0) 
    ...
    if ($result->num_rows > 0) 
        ...
        {
            $sql="INSERT INTO batting (`striker_name`, `nonstriker_name`, `team_name_bat`,`inning_num_bat`) VALUES ('$striker_name','$non_striker_name','$team_name_a','$inning_num')";
            ...
            if($result)
            {
                 ...
                 $_SESSION['team_name_bat']=$team_name_a;
                 echo "<script> window.location.assign('bowling_details_b.php'); </script>";
            }
            else{
