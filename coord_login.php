...
<section class="text-gray-400 bg-gray-900 body-font">
  <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
    <div class="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
      <h1 class="title-font font-medium text-3xl text-white">CO-ORDINATOR LOGIN PORTAL</h1>
      <p class="leading-relaxed mt-4">Make sure that u are registered as co-ordinator first.</p>
    </div>
    <div class="lg:w-2/6 md:w-1/2 bg-gray-800 bg-opacity-50 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
      <h2 class="text-white text-lg font-medium title-font mb-5">Co-ordinator Login</h2>
      <form action="coord_login.php" method="post">
...
$conn=mysqli_connect($host,$user,$password,"co-ordinator");
...
if(isset($_POST['username'])){
    ...
    $sql="SELECT * from coordinator_reg where username='".$uname."'AND password='".$password."' limit 1";
    ...
    if(mysqli_num_rows($result)==1){
        ...
        echo "<script> window.location.assign('welcome_c.php'); </script>";
        exit();
    }
    else{
